...
```{r problem_2, exercise=tutorialize,exercise.setup=problem_1}
...
```{r problem_4, exercise=tutorialize,exercise.setup=problem_3}
NPP[1,]
```
...
```{r problem_5, exercise=tutorialize,exercise.setup=problem_3}
...
```{r problem_6, exercise=tutorialize,exercise.setup=problem_5}
...
```{r problem_7, exercise=tutorialize}
data(iris)
