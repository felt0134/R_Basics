...
```{r problem_mutate, exercise = tutorialize}
...
```{r problem_filter, exercise = tutorialize,exercise.setup=problem_mutate}
...
```{r problem_select, exercise = tutorialize,exercise.setup=problem_filter}
...
```{r problem_arrange, exercise = tutorialize,exercise.setup=problem_select}
