...
Finally, multiply `two` by `twenty_five` and name this calculation as a third value called
`fifty`. Print it so that the new object returns the value of the calculation.
