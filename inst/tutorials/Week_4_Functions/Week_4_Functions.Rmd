...
*it is also good practice to use the `<-` operator specifically for assigning objects names, anf the `=` operator for specifying what values will be passed into a function, for a given argument.
