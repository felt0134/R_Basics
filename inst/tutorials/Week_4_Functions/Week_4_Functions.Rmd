...
Add the R code to the code below (under 'zeros <- rep(0,20)') that will add alternating values of 0 and 1 to the vector named toy_vector. Use the `?` operator to see what the `rep()` function does. 
